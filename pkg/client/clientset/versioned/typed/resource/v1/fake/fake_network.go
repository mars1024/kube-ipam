...
var networksResource = schema.GroupVersionResource{Group: "resource.k8s.io", Version: "v1", Resource: "networks"}

var networksKind = schema.GroupVersionKind{Group: "resource.k8s.io", Version: "v1", Kind: "Network"}
...
func (c *FakeNetworks) Get(name string, options v1.GetOptions) (result *resourcev1.Network, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(networksResource, name), &resourcev1.Network{})
	if obj == nil {
		return nil, err
	}
	return obj.(*resourcev1.Network), err
}
...
func (c *FakeNetworks) List(opts v1.ListOptions) (result *resourcev1.NetworkList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(networksResource, networksKind, opts), &resourcev1.NetworkList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &resourcev1.NetworkList{ListMeta: obj.(*resourcev1.NetworkList).ListMeta}
	for _, item := range obj.(*resourcev1.NetworkList).Items {
...
func (c *FakeNetworks) Create(network *resourcev1.Network) (result *resourcev1.Network, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(networksResource, network), &resourcev1.Network{})
	if obj == nil {
		return nil, err
	}
	return obj.(*resourcev1.Network), err
...
func (c *FakeNetworks) Update(network *resourcev1.Network) (result *resourcev1.Network, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(networksResource, network), &resourcev1.Network{})
	if obj == nil {
		return nil, err
	}
	return obj.(*resourcev1.Network), err
...
func (c *FakeNetworks) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(networksResource, name), &resourcev1.Network{})
	return err
}
...
func (c *FakeNetworks) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &resourcev1.NetworkList{})
	return err
}
...
func (c *FakeNetworks) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *resourcev1.Network, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(networksResource, name, data, subresources...), &resourcev1.Network{})
	if obj == nil {
		return nil, err
	}
	return obj.(*resourcev1.Network), err
